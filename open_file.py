...
class myThread(threading.Thread):
        ...
        def run(self):
                ...
                for i in range(0, sheet.nrows):
                        ...
                        #print("start")
                        check = create_files_per_protein(protein_name, sequence, final_sheet, log_file, True)
                        if(check[0] != 0):
...
def create_files_per_protein(protein_name, sequence, final_sheet, log_file, write_error):
        global row_count
        global folder_name
